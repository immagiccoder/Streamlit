# -*- coding: utf-8 -*-
"""
Created on Fri Feb 25 10:40:10 2022
    ...
    if file!= None:
        ...
        def findObjects(outputs,img):
            ...
            for i in indices:
                ...
                cv2.rectangle(img2, (x, y), (x+w,y+h), (40, 54 , 40), 2)
...
def object_detection_video():
    ...
    if uploaded_video != None:
        ...
        cv2.destroyAllWindows()
def main():
    new_title = '<p style="font-size: 42px;">IDS InfoTech Ltd Object Detection App!</p>'
